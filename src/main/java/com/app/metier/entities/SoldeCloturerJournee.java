...
public class SoldeCloturerJournee implements Serializable{
	...
	private int id;
	public SoldeCloturerJournee() {
		super();
	}
	public SoldeCloturerJournee(double caisse, double orange, double expresso, double freemoney, double wari, double wizall,
